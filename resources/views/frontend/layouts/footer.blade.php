        ...
        <div class="container">
            <div class="row" id="accordionFooter">
                <div class="col-12 col-md-4 col-lg-4">
                    ...
                    <!-- Brand -->
                    <img style="width: 70%;" src="{{ asset('images/logo.png')}}" alt="..." class="footer-brand img-fluid mb-4 h-60p">
                    ...
                    <div class="mb-4">
                        <a href="mailto:hr@thewebpatriot.com" class="text-gray-800 font-size-sm-alone">hr@thewebpatriot.com</a>
                    </div>  --}}
                ...
                <div class="col-12 mt-md-5">
                    <div class="border-top pb-5 pt-6 py-md-4 text-center text-xl-start d-flex flex-column d-md-block d-xl-flex flex-xl-row align-items-center">
                        <p class="text-gray-800 font-size-sm-alone d-block mb-0 mb-md-2 mb-xl-0 order-1 order-md-0 px-9 px-md-0">Copyright © 2022 <a href="https://thewebpatriot.com">TheWebPatriot</a> All Right Reserved.</p>
