...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.content-pages.update", [$contentPage->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="featured_image" class="required">{{ trans('cruds.contentPage.fields.featured_image') }}</label>
                ...
                <span class="text-danger" id="reqmsg" style="display:none;">The File is required</span>
            </div>
            <div class="form-group">
...
<script>
  ...
  var myDropzone = new Dropzone('#featured_image-dropzone',{
